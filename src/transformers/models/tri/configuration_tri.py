...
class TriConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`TriModel`]. It is used to instantiate an Tri model
    according to the specified arguments, defining the model architecture. Instantiating a configuration with the defaults
    will yield a similar configuration to that of the Tri-70B.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 124416):
            ...
            `inputs_ids` passed when calling [`TriModel`]
        ...
        pad_token_id (`int`, *optional*, defaults to 124415):
            Padding token id.
        bos_token_id (`int`, *optional*, defaults to 123964):
            Beginning of stream token id.
        eos_token_id (`int`, *optional*, defaults to 123972):
        ...
        rope_scaling (`Dict`, *optional*):
            ...
            Expected contents:
                ...
                `long_factor` (`List[float]`, *optional*):
                    ...
                    `original_max_position_embeddings`). Must be a list of numbers with the same length as the hidden
                    size divided by the number of attention heads divided by 2
        global_attention_freq (`int`, *optional*, defaults to 5):
            Use NoPE layer for every `global_attention_freq - 1` layers.
        ...
        attn_scale (`float`, *optional*, defaults to 0.1): TODO
        floor_scale (`float`, *optional*, defaults to 0.1): TODO
    ...
    ```python
    >>> from transformers import TriModel, TriConfig

    >>> # Initializing a Tri style configuration
    >>> configuration = TriConfig()

    >>> # Initializing a model from the Tri style configuration
    >>> model = TriModel(configuration)
    ...
    # Default tensor parallel plan for base model `TriModel`
    base_model_tp_plan = {
